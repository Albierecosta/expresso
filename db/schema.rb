...
ActiveRecord::Schema[8.0].define(version: 2026_06_05_191538) do
  ...
  create_table "deliveries", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["freight_id"], name: "index_deliveries_on_freight_id", unique: true
  end
  ...
  add_foreign_key "deliveries", "freights"
